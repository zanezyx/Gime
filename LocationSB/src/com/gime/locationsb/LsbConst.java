...
public class LsbConst {
	...
	public final static  String LSB_HTTP_URL_SEND_OP = "http://192.168.0.61/LocationSB/location.php";
	public final static  String LSB_HTTP_URL_QUERY = "http://192.168.0.61/LocationSB/query.php";
	public final static  String LSB_HTTP_URL_GET_LOCATION = "http://192.168.0.61/LocationSB/getlocation.php";
